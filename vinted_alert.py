...
def est_valide(titre, description, mots_requis):
    ...
    # Vérifie que tous les mots requis sont dans le titre/description
    for mot in mots_requis:
        if mot not in texte:
            return False
    # Vérifie qu'aucun mot exclu n'est présent
